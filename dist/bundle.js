...
const UI = (() => {
  ...
  const updateCellColor = (cell, color) => {
    ...
    document.querySelector(`[data-index="${cell}"]`).style.backgroundColor = colors[color];
  };
...
module.exports = __webpack_require__.p + "f50e921818e92325f34f.svg";
